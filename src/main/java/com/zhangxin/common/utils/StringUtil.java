...
public class StringUtil {
		...
		public static String randomChineseString(){
			...
			higthPos=(176+random.nextInt(40));
			random = new Random();
			lowPos=161+random.nextInt(94);
			byte[] array=new byte[2];
			array[0]=(new Integer(higthPos)).byteValue();
			array[1]=(new Integer(lowPos)).byteValue();
			try {
				str = new String(array,"GB2312");
